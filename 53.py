...
def make_graph():
    ...
    sheet = book.sheet_by_index(1) #code select sheet ถ้ามีสองชีทเปลี่ยนเป็นเลข 1
    ...
    line_chart.title = ('ภาวะการทำงานของประชากรปี 2553')
    career = []
    ...
    line_chart.render_to_file('53.svg')
make_graph()
